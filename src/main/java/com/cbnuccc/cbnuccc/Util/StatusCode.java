...
public enum StatusCode {
    ...
    NOT_VERIFIED(HttpStatus.FORBIDDEN, "주어진 유저는 유효하지 않습니다. (이메일 인증이 안 되었습니다)", 10),
    ...
    CANNOT_SEND_EMAIL_WITHIN_10_SECONDS(HttpStatus.BAD_REQUEST, "이메일 요청을 10초 이내에 다시 요구할 수 없습니다.", 17),
